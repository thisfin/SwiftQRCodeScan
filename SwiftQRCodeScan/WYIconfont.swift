...
class WYIconfont: NSObject {
    ...
    public class func fontOfSize(_ fontSize: CGFloat) -> UIFont {
        _ = oneTimeThing
    ...
    public class func setFont(fontPath: String, fontName: String) {
        WYIconfont.fontPath = fontPath
        WYIconfont.fontName = fontName
    }
    
    public class func imageWithIcon(content: String, backgroundColor: UIColor = UIColor.clear, iconColor: UIColor = UIColor.white, size: CGSize) -> UIImage {
    ...
    private class func constraintLabelToSize(label: UILabel, size: CGSize, maxFontSize: CGFloat, minFontSize: CGFloat) -> CGFloat {
    ...
    public class func imageWithIcon(content: String, backgroundColor: UIColor = UIColor.clear, iconColor: UIColor = UIColor.white, fontSize: CGFloat) -> UIImage {
        let font = WYIconfont.fontOfSize(fontSize)
        let style: NSMutableParagraphStyle = NSParagraphStyle.default.mutableCopy() as! NSMutableParagraphStyle
        style.alignment = NSTextAlignment.center
